                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Image.network(
                            listOther![index].routes.bus.image_Bus,
                            width: 120.0,
                            height: 120.0,
                            fit: BoxFit.cover,
                          ),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                listOther![index].routes.school.school_name,
                                style: const TextStyle(
                                    fontSize: 16,
                                    fontWeight: FontWeight.w500),
                              ),
                              ...
                              Text(
                                listOther![index].routes.bus.driver.firstname+" "+listOther![index].routes.bus.driver.lastname,
                                style: const TextStyle(
                                    fontSize: 16,
                                    fontWeight: FontWeight.w500),
                              ),
