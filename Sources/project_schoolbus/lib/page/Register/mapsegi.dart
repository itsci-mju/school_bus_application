...
class mapregi extends StatefulWidget {
  const mapregi({Key? key}) : super(key: key);

  @override
  State<mapregi> createState() => _ShowMapState();
}

class _ShowMapState extends State<mapregi> {
