...
class ListChildrenActivity extends StatefulWidget {
  const ListChildrenActivity({Key? key}) : super(key: key);

  @override
  State<ListChildrenActivity> createState() => _ListChildrenActivityState();
}

class _ListChildrenActivityState extends State<ListChildrenActivity>{
  ...
  void refreshChildren() async {
    ...
    manager.driver_listChildren1(num_plate).then((value) async => {
      setState(() {
        listChildren = value;
        isLoading = false;
      }),
  ...
  void getlistActivityis1() {
    ...
    amanager.listActivitytime1().then((value)  async => {
      setState(() {
                                  ...
                                  child: ElevatedButton(
                                    onPressed: () async {
                                      ...
                                      Activity activity = Activity("",_position!.latitude.toString(),_position!.longitude.toString(),DateFormat('yyyy-MM-dd HH:mm:ss').format(d)
                                          ,"","","1900-01-01 00:00:00","",1,"อยู่บนรถ",listChildren![index]);
                                                            ...
                                                            onPressed:
                                                              ...
                                                              if(_ctrlreason.text == ''){
                                                                ...
                                                                Activity activity = Activity("","","",DateFormat('yyyy-MM-dd 00:00:00').format(d)
                                                                    ,"","",DateFormat('yyyy-MM-dd 00:00:00').format(d),_ctrlreason.text,1,"ไม่ขึ้นรถ",listChildren![index]);
                                                                doaddActivity(context,activity);
                                                              }
                                                              setState(() {
                                                                _ctrlreason.text = '';
